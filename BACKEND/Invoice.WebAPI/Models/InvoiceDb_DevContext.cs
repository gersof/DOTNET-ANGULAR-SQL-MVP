...
{
    public partial class InvoiceDb_DevContext : DbContext
    {
        public InvoiceDb_DevContext()
        {
        }

        public InvoiceDb_DevContext(DbContextOptions<InvoiceDb_DevContext> options)
            : base(options)
        {
        }
